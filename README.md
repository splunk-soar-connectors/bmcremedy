...
This table lists the configuration variables required to operate BMC Remedy. These variables are specified when configuring a BMC Remedy asset in Splunk SOAR.
